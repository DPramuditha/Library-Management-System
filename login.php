<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        if(empty($errors)){
            $stmt = $conn-> prepare("SELECT id, name, email, password, role FORM users WHERE email = ? AND is_active = 1");
        ...
        <div class="bg-white rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 hover:shadow-lg transition-shadow duration-300 max-w-md w-full mx-auto">
            ...
            <div class="mt-6 lg:mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div class="mt-6">
                    <button
                        type="button"
                        class="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-indigo-600 transform duration-300"
                    >
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="register.html" class="text-indigo-600 hover:text-indigo-500 font-semibold">
                            Sign up
                        </a>
                    </p>
                </div>
